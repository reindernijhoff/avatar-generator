...
import {generateAvatar as generatePixels} from '../../src/themes/pixels/index.js';
...
import type {PixelsOptions} from '../../src/themes/pixels/types.js';
...
function generateSingleAvatar(id: string, size: number): HTMLCanvasElement {
    ...
    } else if (currentTheme === 'pixels') {
        canvas = generatePixels({
            id,
            size,
            gridSize: 9,
            ...colorOptions,
